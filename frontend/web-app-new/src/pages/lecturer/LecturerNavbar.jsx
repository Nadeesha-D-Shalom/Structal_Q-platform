    ...
    <header className="h-[78px] bg-white border-b border-[#e7ebf1] flex items-center justify-between px-8">
      ...
      <div className="flex items-center">
        ...
        <nav className="flex items-center gap-9 text-[12px] font-medium">
          <div className={getItemStyle("Dashboard")} onClick={() => navigate(routeMap["Dashboard"])}>
            <i className="fas fa-border-all text-[12px]"></i>
            <span>Dashboard</span>
          </div>

          <div className={getItemStyle("Subjects")} onClick={() => navigate(routeMap["Subjects"])}>
            <i className="far fa-clipboard text-[12px]"></i>
            <span>Subjects</span>
          </div>

          <div className={getItemStyle("Grades & Marks")} onClick={() => navigate(routeMap["Grades & Marks"])}>
            <i className="fas fa-star text-[12px]"></i>
            <span>Grades &amp; Marks</span>
          </div>

          <div className={getItemStyle("Publish Marks")} onClick={() => navigate(routeMap["Publish Marks"])}>
            <i className="fas fa-check-double text-[12px]"></i>
            <span>Publish Marks</span>
          </div>

          <div className={getItemStyle("Timetable")} onClick={() => navigate(routeMap["Timetable"])}>
            <i className="far fa-calendar-alt text-[12px]"></i>
            <span>Timetable</span>
          </div>

          <div className={getItemStyle("Submissions")} onClick={() => navigate(routeMap["Submissions"])}>
            <i className="far fa-file-alt text-[12px]"></i>
            <span>Submissions</span>
          </div>

          {/* Member 05 - Evaluation Scheduling */}
          <div className={getItemStyle("Evaluation")} onClick={() => navigate(routeMap["Evaluation"])}>
