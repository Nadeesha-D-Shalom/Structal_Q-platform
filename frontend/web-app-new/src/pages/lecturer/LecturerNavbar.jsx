...
const LecturerNavbar = () => {
  ...
  const profile = useMemo(() => {
    try {
      ...
      if (!raw) return { name: "Lecturer", idLabel: "" };
  ...
  const getActivePage = () => {
    ...
    if (path.startsWith("/lecturer/timetable") || path.startsWith("/lecturer-view")) return "Timetable";
    if (path.startsWith("/create") || path.startsWith("/edit/")) return "Timetable";
